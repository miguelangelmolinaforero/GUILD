...
?>
    ...
    <head>
        ...
        <!-- Custom CSS -->
        <link href="../../../GUILD/assets/css/cesta_styles.css" rel="stylesheet">
                              ...
                              if ($res->num_rows > 0) {
                                  while ($row = $res->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo "<b class='text-success'>$nombre_p</b>"; ?></td>
                                        <td>
                                            <?php echo "<p class='text-info'>$descri_p</p>"; ?>
                                        </td>
                                        <td>
                                            <?php echo $categoria; ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php echo "<b class='text-danger'>$$of_final.00</b>"; ?></td>
                                    </tr>
